...
namespace CaravanAdventures.CaravanCamp
{
    class ProductionTent : Tent, IRecipeHolder, IShelfTent
    {
        ...
        public virtual void ApplyRecipes(Caravan caravan)
        {
            ...
            var fuelFromCorpseBill = new Bill_ProductionWithUft(DefDatabase<RecipeDef>.GetNamed("CAMake_ChemfuelFromCorpses")) { repeatMode = BillRepeatModeDefOf.Forever, ingredientFilter = new ThingFilter( };
