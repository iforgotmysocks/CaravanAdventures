...
{
    public class JobDriver_StartPackingUP : JobDriver
    {
        public ThingWithComps ControlSpot => this.job.GetTarget(TargetIndex.A).Thing as ThingWithComps;
        public override bool TryMakePreToilReservations(bool errorOnFailed) =>
            this.pawn.Reserve(this.job.targetA, this.job, 1, -1, null, errorOnFailed);

        protected CompCampControl comp;
        protected int durationForOneTent = 60;
