...
namespace CaravanAdventures
{
    ...
    static class InitPatches
    {
        ...
        static InitPatches()
        {
            ...
            {
                Helper.RunSafely(PatchAddCaravanDecisionsComp);
                Helper.RunSafely(PatchAddPsychiteTeaToCampFire);
            }
        ...
        private static void PatchAncientShrineDefs_MoreShrinesAndBetterRewards()
        {
            ...
            if (root != null)
            {
                ...
                thingSetMaker_Count.fixedParams.filter.Allows(DefDatabase<ThingDef>.GetNamedSilentFail("VanometricPowerCell"));
                thingSetMaker_Count.fixedParams.filter.Allows(DefDatabase<ThingDef>.GetNamedSilentFail("InfiniteChemreactor"));
