...
namespace CaravanAdventures.Patches
{
    ...
    class AutomaticItemSelection
    {
        ...
        public static void Dialog_FormCaravan_Postfix(Dialog_FormCaravan __instance, ref bool ___autoSelectTravelSupplies, Map ___map)
        {
        ...
        {
            GUI.BeginGroup(new Rect(525f, 0f, 525f, 27f));
