...
namespace CaravanAdventures.Patches
{
    internal class BossPatches
    {
        public static void ApplyPatches(Harmony harmony)
        {
			...
			var projectOrg = AccessTools.Method(typeof(CompProjectileInterceptor), nameof(CompProjectileInterceptor.CheckIntercept));
			var projectPost = new HarmonyMethod(typeof(BossPatches).GetMethod(nameof(CheckInterceptPostFix)));
			harmony.Patch(projectOrg, null, projectPost);
		}
