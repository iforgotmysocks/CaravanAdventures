...
namespace CaravanAdventures.Settings
{
    class SettingsOther : Page
    {
        ...
        public override void DoWindowContents(Rect wrect)
        {
            ...
            options.CheckboxLabeled("Increase settlement's and orbital trader's available silver and food by 2-3 and 1.5-2, respectively", ref ModSettings.buffSettlementFoodAndSilverAvailability);
